  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="/login" method="post">
        ...
        <input name="userId" value="brown" type="text" id="userId" class="form-control" placeholder="Email address" required autofocus>
        <label for="inputPassword" class="sr-only">Password</label>
        <input name="pass" value="1234" type="password" id="inputPassword" class="form-control" placeholder="Password" required>
        <div class="checkbox">
          <label>
